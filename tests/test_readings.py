...
def test_get_readings_history_24h(client, mock_repo):
    mock_data = [
        {
            "bucket": "2026-06-26T21:00:00+00:00",
            "avg_ph": 7.1,
            "avg_tds": 240.0,
            "avg_turbidity": 14.0,
            "avg_wqi": 84.0,
    ...
    mock_repo.get_hourly_readings.assert_called_once_with(
        "mock-user-uuid-123", limit=24
    )
...
def test_get_readings_history_7d(client, mock_repo):
    mock_data = [
        {
            "bucket": "2026-06-26T00:00:00+00:00",
            "avg_ph": 7.3,
            "avg_tds": 245.0,
            "avg_turbidity": 14.5,
            "avg_wqi": 86.0,
...
def test_get_readings_history_invalid_range(client):
    ...
    )  # Pydantic query param validation failure status code
