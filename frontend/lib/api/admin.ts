...
export async function getAdminAlerts(params: GetAlertsParams = {}) {
  ...
  if (params.isAcknowledged !== undefined) query.append('is_acknowledged', params.isAcknowledged.toString())
  if (params.isResolved !== undefined) query.append('is_resolved', params.isResolved.toString())
  if (params.page) query.append('page', params.page.toString())
  if (params.limit) query.append('limit', params.limit.toString())
...
export async function getAdminML(params: GetMLParams = {}) {
  ...
  if (params.isAnomaly !== undefined) query.append('is_anomaly', params.isAnomaly.toString())
  if (params.page) query.append('page', params.page.toString())
  if (params.limit) query.append('limit', params.limit.toString())
