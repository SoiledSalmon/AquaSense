      ...
      <main className="flex-1 max-w-7xl mx-auto px-6 flex flex-col items-center justify-center text-center py-20 z-10">
        <div className="max-w-3xl space-y-6">
          ...
          <p className="text-lg sm:text-xl text-slate-400 leading-relaxed max-w-2xl mx-auto">
            Monitor and secure water resources with high-frequency telemetry,
            edge integration, and predictive machine learning diagnostics.
          </p>
        ...
        <section className="mt-28 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full text-left">
          ...
          <div className="p-6 bg-slate-900/40 border border-slate-900 rounded-2xl backdrop-blur-md hover:border-slate-800 transition-all duration-200 group">
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              Ingest sensor updates (pH, TDS, Turbidity) using low-latency MQTT
              brokers and view immediate updates pushed via SSE streams.
            </p>
          </div>
          ...
          <div className="p-6 bg-slate-900/40 border border-slate-900 rounded-2xl backdrop-blur-md hover:border-slate-800 transition-all duration-200 group">
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              XGBoost classifier predicts safety status (Safe, Borderline,
              Unsafe) with exact SHAP tree values detailing parameter
              contributions.
            </p>
          </div>
          ...
          <div className="p-6 bg-slate-900/40 border border-slate-900 rounded-2xl backdrop-blur-md hover:border-slate-800 transition-all duration-200 group">
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              Isolation Forest model scans telemetry against EWMA-smoothed
              parameters to detect sensor drift, errors, and system anomalies.
            </p>
          </div>
          ...
          <div className="p-6 bg-slate-900/40 border border-slate-900 rounded-2xl backdrop-blur-md hover:border-slate-800 transition-all duration-200 group">
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              Get notified immediately of abnormal readings with clear
              classifications, severity markers, and actionable recommendations.
            </p>
          </div>
        </section>
      </main>
