...
async def test_mqtt_ml_db_sse_integration():
    ...
    repo.get_recent_readings = AsyncMock(return_value=[])  # Empty history for simplicity
    repo.update_reading_ml = AsyncMock(return_value={**mock_inserted_reading, "wqi_score": 100.0, "label": "safe"})
